...
public:
  ...
  IncomingPacket(const Type type, const uint8_t flags, const size_t size,
                 Client &client);
  ...
  // This operator is not marked explicit in the Client base class.  Still,
  // we're marking it explicit here to block implicit conversions to integer
  // types.
