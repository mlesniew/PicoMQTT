...
const char *
SubscribedMessageListener::get_subscription_pattern(SubscriptionId id) const {
  TRACE_FUNCTION
...
SubscribedMessageListener::get_subscription(const char *topic) const {
  TRACE_FUNCTION
  for (const auto &kv : subscriptions) {
...
Subscriber::SubscriptionId
SubscribedMessageListener::subscribe(const String &topic_filter) {
  TRACE_FUNCTION
...
void SubscribedMessageListener::fire_message_callbacks(const char *topic,
